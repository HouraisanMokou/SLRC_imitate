...
from models.orignal.SLRC_BPR import SLRC_BPR
from models.orignal.SLRC_NCF import SLRC_NCF
from models.orignal.SLRC_Tensor import SLRC_Tensor
...
def get_args():
    ...
    parser.add_argument(
        "--data_directory", type=str, default="./data", help="original data directory"
    )
    parser.add_argument(
        "--save_directory", type=str, default="./result", help="Save data directory"
    )
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="whether to load model already exist",
    )
    parser.add_argument(
        "--model_name", type=str, default="SLRC_BPR", help="the name of model"
    )
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="Grocery_and_Gourmet_Food",
    ...
    parser.add_argument(
        ...
        type=str,
        default="./data",
        help="the path of directory of corpus",
    )
    parser.add_argument(
        "--load_corpus",
        type=bool,
        default=False,
        help="whether to load corpus already exist",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="./result",
        help="the directory the log would be saved to",
    )
    parser.add_argument(
        "--random_state", type=int, default=2021, help="the random seed"
    )

    parser.add_argument(
        "--logging_file_name", type=str, default="", help="the file name of logging"
    )
    parser.add_argument(
        "--model_file_name", type=str, default="", help="the file name of saved model"
    )
    ...
    parser.add_argument(
        "--time_scale", type=int, default=24 * 7 * 10, help="the time scale"
    )
    ...
    parser.add_argument(
        "--num_workers", type=int, default=0, help="workers of io used in loading data"
    )
    parser.add_argument(
        "--pin_memory", type=int, default=1, help="the length of embedding vector"
    )
...
def main(args):
    ...
    if args.logging_file_name == "":
        args.logging_file_name = os.path.join(
